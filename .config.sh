alias r=". ranger"
alias arch="distrobox enter arch -- zsh"
alias l="ls"
alias ll="ls -l"
alias la="ls -a"
alias c="clear"
...
alias vpn='echo Wyb1e8ad6### | sudo openconnect vpn.ucsd.edu -u y2wei --authgroup "2-Step Secured - allthruucsd" --passwd-on-stdin'
# Tmux
...
alias restartnv="sudo rmmod nvidia_uvm && sudo modprobe nvidia_uvm"
